    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <ScrollView horizontal style={{marginTop: 15}}>
          <Image style={slider.image} source={{uri: 'https://lelogama.go-jek.com/post_featured_image/promo-ramadhan-go-food-extension.jpg'}}></Image>
          <Image style={slider.image} source={{uri: 'https://lelogama.go-jek.com/post_featured_image/promo-hangout-bandung-1png.png'}}></Image>
          <Image style={slider.image} source={{uri: 'https://lelogama.go-jek.com/post_featured_image/promo-12-12-gomart.png'}}></Image>
          <Image style={slider.image} source={{uri: 'https://lelogama.go-jek.com/post_thumbnail/promo-gopay-belanja-0.jpg'}}></Image>
        </ScrollView>
      <View style={{flexDirection: 'row',marginHorizontal: 12, paddingRight: 100,marginTop: 10}}>
          <Image style={{width: 100, height: 100, borderRadius: 20}} source={{uri: 'https://lelogama.go-jek.com/post_featured_image/SBY_Kakkk_Ayam_Geprek.png'}}></Image>
        ...
        <View style={{flexDirection: 'row',marginHorizontal: 12, paddingRight: 100,marginTop: 10}}>
          <Image style={{width: 100, height: 100, borderRadius: 20}} source={{uri: 'https://o-cdn-cas.sirclocdn.com/parenting/images/Mie_Setan.width-800.format-webp.webp'}}></Image>
          <View style={{marginLeft: 10}}>
            <Text style={{fontWeight: 'bold',color: 'black'}}>
              Mie Gacoan
            </Text>
        ...
        <View style={{flexDirection: 'row',marginHorizontal: 12, paddingRight: 100,marginTop: 10}}>
          <Image style={{width: 100, height: 100, borderRadius: 20}} source={{uri: 'https://jabarekspres.com/wp-content/uploads/2023/06/91a3a6b0-153a-4817-97d0-2508380d0b96.jpg'}}></Image>
          <View style={{marginLeft: 10}}>
            <Text style={{fontWeight: 'bold',color: 'black'}}>
              Ramen
            </Text>
...
const slider = StyleSheet.create({
  image: {width: 375,height: 180,marginHorizontal: 10,borderRadius: 20,resizeMode: 'contain'}
})
